...
def initialize(context):
    ...
    algo.schedule_function(func=rebalance,
                         ...
                         time_rule=algo.time_rules.market_open(hours=0, minutes=25),
                           half_days=True)
...
def make_pipeline():
    ...
    enterprise_value_winsorized = enterprise_value.winsorize(min_percentile=0.05,
                                                max_percentile=0.95)
